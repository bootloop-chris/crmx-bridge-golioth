...
void Style::init_button_styles() {
  ...
  lv_style_set_border_width(&btn_style_base, 1);
  ...
  lv_style_set_border_opa(&btn_style_focus, LV_OPA_100);
  // TODO: why doesn't this work
  // lv_style_set_radius(&btn_style_focus, 2);
  lv_style_set_bg_color(&btn_style_focus, bg_color);
  lv_style_set_bg_opa(&btn_style_focus, LV_OPA_100);
  // lv_style_set_text_color(&btn_style_focus, bg_color);

  lv_style_init(&btn_style_click);
  lv_style_set_border_color(&btn_style_click, bg_color);
  lv_style_set_border_opa(&btn_style_click, LV_OPA_100);
  // TODO: why doesn't this work
  // lv_style_set_radius(&btn_style_click, 2);
  lv_style_set_bg_color(&btn_style_click, fg_color);
  lv_style_set_bg_opa(&btn_style_click, LV_OPA_100);
